        ...
        <h1>About Me</h1>
          <p>As you can already tell my name is Emily but I'm also known as Emmie. I've lived in Southampton all my life. I've had Type One Diabetes for 31 years this year (2019).
           ...
           <br>
            ...
            Within a new role in Southampton's Community Nursing Services admin team I took on roles around educating staff how to use new technologies, such as blackberries and then notebooks to keep records online with SystemOne. I became a trainer for the SystemOne role out, which was a challenge because not all the staff embraced the new system so needed a bit more convincing and training that paperless records was the way forward. I also worked very closely with the Service Manager in creating a spreadsheet that worked out a daily alert system to define each community nursing teams capacity for new patients.This report was then escalated daily to senior management to liaise with hospital discharge so decisions could be made if it was safe to discharge patients home safely with right amount of nursing care.
            <br>
