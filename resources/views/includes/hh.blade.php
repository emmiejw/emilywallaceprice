<div class="workHistory">
        <h4 class="text-center"><b>Web Developer for Hypo Hounds</b> </h4>
         ...
         <p>
                A good friend of mine is the CEO of a charity called Hypo Hounds, who train pet dogs to alert their type 1 diabetic owners to impending blood glucose level changes, which these dogs can detect from a minute odour change in the owners scent. I knew the CEO at the time had to manually every 3 months go through clients' individual blood glucose diary and the alert diary of the dog, which was very time consuming for her. 
                ...
                This was my first live project that was going to be used in the real world and my focus was to make it user friendly and quick to use. Making the site was one thing but I had to learn about and how to deploy to a server and the relevant SSL certificates, setting up domains and namespaces for the server. 
                I produced user guides for the clients and how to register an account and use the diary system. For the more visual people I created youtube videos as a guide. 
