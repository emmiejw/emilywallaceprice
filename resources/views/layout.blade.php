...
<script>
    function hhFunction() {
        document.getElementById("hh").innerHTML = "To make the website more dynamic and security safe I created an admin area, which only authenticated staff members could access. The team could then view individual clients diaries (clients are only able to view their own diary for confidentiality). This helps with continuous assessment as and when it is needed. Within the admin area I also created a separate section for the team to hold clinical trials records. Due to this being a new method of data collection for the clients I produced 'How to use guide' with descriptions and screenshots and for those who prefer a video I added a demonstration video using my mobile phone.";
        
    }
    function ssFunction() {
        document.getElementById("ss").innerHTML = "The Manager wanted to be able to authorise feedback posts before they appeared on the site, so I added an authorisation functionality within the admin panel, therefor posts could be easily read and then a click of a button authorised or deleted a post. I used Laravel email notifications so the Manager receives an email alerting her of new testimonial was awaiting approval. I enjoyed designing the frontend of the website and utilised the logo they already had, which is rainbow footprints with 'Stepping Stones' so I decided to go with a rainbow colour wash to compliment the logo and support the artistic talents within the pre-school.";
    }
</script>
